...
public class DragAndSwipeRecyclerListAdapter extends RecyclerView.Adapter<DragAndSwipeRecyclerListAdapter.ItemViewHolder>
    ...
    public DragAndSwipeRecyclerListAdapter(Context context, OnStartDragListener dragStartListener) {
